...
def resume_training(checkpoint_path, waste_classification_path, household_waste_path, garbage_dataset_path, realwaste_path, use_only_landfill_from_new=False):
    ...
    # Start a new MLflow run for resumed training
    with mlflow.start_run(run_name=f"waste_classifier_resume_{timestamp}") as run:
...
if __name__ == "__main__":
    ...
    checkpoint_path = "models/run_20250511_014528/checkpoint_epoch_10.pth"
    ...
    print("View MLflow UI with: mlflow ui --backend-store-uri sqlite:////Users/shruti/USF-Spring-2/deep_learning/mlflow.db") 